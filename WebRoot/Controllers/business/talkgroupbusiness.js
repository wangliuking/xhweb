...
xh.load = function() {
	...
	app.controller("talkgroupbusiness", function($scope, $http) {
		xh.maskShow();
		$scope.count = "20";// 每页数据显示默认值
		$scope.systemMenu = true; // 菜单变色
		$http.get(
				"../../talkgroupbusiness/list?start=0&limit=" + pageSize).success(
				function(response) {
					xh.maskHide();
...
// 刷新数据
xh.refresh = function() {
	var appElement = document.querySelector('[ng-controller=talkgroupbusiness]');

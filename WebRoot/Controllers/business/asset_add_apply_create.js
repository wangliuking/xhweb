...
xh.load = function() {
	...
	app.controller("xhcontroller", function($scope,$http) {
		...
		$scope.isLockAsset=function(){
			$http.get("../../business/assetList?isLock=1&tag=1&applyTag=&type=0&name=" +
					"&model=&serialNumber=&from=0" +
					"&status=0&start=0&limit=500").
		...
		$scope.search = function(page) {
			...
			xh.maskShow();
			$http.get("../../business/assetList?isLock=1&tag=1&applyTag=&type="+type+"&name="+name+"" +

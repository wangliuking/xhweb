...
xh.load = function() {
	...
	app.controller("xhcontroller", function($scope, $http) {
		...
		$http.get("../../repeaterbs/list?start=0&limit=" + $scope.count).success(
				function(response) {
					xh.maskHide();
		...
		$scope.search = function(page) {
			...
			xh.maskShow();
			$http.get("../../repeaterbs/list?start="+start+

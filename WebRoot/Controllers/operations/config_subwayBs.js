...
xh.load = function() {
	...
	app.controller("xhcontroller", function($scope, $http) {
		...
		$http.get("../../subwaybs/list?line=0&start=0&limit=" + $scope.count).success(
				function(response) {
					xh.maskHide();
		...
		$scope.search = function(page) {
			...
			xh.maskShow();
			$http.get("../../subwaybs/list?line="+line+"&start="+start+
		...
		$scope.pageClick = function(page, totals, totalPages) {
			...
			xh.maskShow();
			$http.get(
					"../../subwaybs/list?line="+line+"&start="+start+
					"&limit=" + pageSize).success(function(response) {
				xh.maskHide();

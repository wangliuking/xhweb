...
xh.load = function() {
	...
	app.controller("xhcontroller", function($scope, $http) {
		...
		$scope.server=function(){
            ...
            var serverNode =xh.createDispatchNode(900, 200, 30, 30,"调度台","circle");
            var link = xh.createNewFoldLink(rootNode, serverNode); 
...
xh.createServerNode=function(x, y, w, h, text,type){

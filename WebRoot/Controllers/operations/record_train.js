...
xh.load = function() {
	...
	app.controller("xhcontroller", function($scope, $http) {
		...
		$http.get("../../recordtrain/data_all?start=0&limit=" + $scope.count).success(
				function(response) {
					xh.maskHide();
		...
		$scope.search = function(page) {
			...
			xh.maskShow();
			$http.get("../../recordtrain/data_all?start="+start+"&time="+time+"" +
		...
		$scope.pageClick = function(page, totals, totalPages) {
			...
			xh.maskShow();
			$http.get(
					"../../recordtrain/data_all?start="+start+"&time="+time+"" +
					"&limit=" + pageSize).success(function(response) {
				xh.maskHide();

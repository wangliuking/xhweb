...
xh.load = function() {
	...
	app.controller("xhcontroller", function($scope, $http) {
		...
		$http.get("../../faultlevel/one_list?type=2&time="+$scope.time+"&start=0&limit=" + $scope.count).success(
				function(response) {
					xh.maskHide();
		...
		$scope.search = function(page) {
			...
			xh.maskShow();
			$http.get("../../faultlevel/one_list?type=2&start="+start+"&time="+starttime+"" +
		...
		$scope.pageClick = function(page, totals, totalPages) {
			...
			xh.maskShow();
			$http.get(
					"../../faultlevel/one_list?type=2&start="+start+"&time="+starttime+"" +
					"&limit=" + pageSize).success(function(response) {
				xh.maskHide();

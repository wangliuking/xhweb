...
$(function () {
    ...
    // 初始化插件参数及插入插件
    var tempWidth = ($(window).width() - $("#loginFrame").width())*0.95;
    var tempHeight = $("#leftRow").height();
    WebVideoCtrl.I_InitPlugin(tempWidth, tempHeight, {
...
//快速登录
var NVR_Map=[{"loginip":"172.18.1.155","port":"80","username":"admin","password":"12345"},
             {"loginip":"172.18.1.156","port":"80","username":"admin","password":"12345"},
             {"loginip":"172.18.1.157","port":"80","username":"admin","password":"12345"},
             {"loginip":"172.18.1.158","port":"80","username":"admin","password":"12345"},
             {"loginip":"192.168.120.175","port":"80","username":"admin","password":"xh123456"},
             {"loginip":"192.168.120.176","port":"80","username":"admin","password":"xh123456"},
             {"loginip":"192.168.120.177","port":"80","username":"admin","password":"xh123456"}
             ]
function quickClickLogin(){
	for(var i=0;i<NVR_Map.length;i++){
		var szIP = NVR_Map[i].loginip,

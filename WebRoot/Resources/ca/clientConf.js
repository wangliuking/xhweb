...
function TopESAConfig() {
    ...
    try {
        ...
        if (e instanceof TCACErr) {
            alert("你还没有安装数字证书驱动，点击确定下载安装,安装后请刷新浏览器");
			window.location.href =projectName+"/Resources/SCCAhelp.exe";
			/*$(".login-top").html("<a herf='"+projectName +"/Resources/SCCAhelp.exe'>你还没有安装数字证书驱动，点击确定下载安装</a>");*/
        } else {
            alert("Here is JS Error123 !!!");
        }
...
for (i = 0, ln = scripts.length; i < ln; i++) {
    ...
    match = scriptSrc.match(/clientConf\.js$/);

...
public class InvokeResponse implements org.apache.axis2.databinding.ADBBean {
	...
	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://FSUService.chinamobile.com", "invokeResponse", "ns2");
		...
		public static InvokeResponse parse(
			...
			try {
						...
						if (!"invokeResponse".equals(type)) {
							...
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (InvokeResponse) com.chinamobile.fsuservice.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("", "invokeReturn")
					...
					if ("true".equals(nillableValue)
						...
						object.setInvokeReturn(org.apache.axis2.databinding.types.soapencoding.String.Factory
								.parse(reader));

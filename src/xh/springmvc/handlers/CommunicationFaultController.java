...
import xh.mybatis.service.CommunicationFaultService;

@Controller
@RequestMapping(value = "/communicationfault")
public class CommunicationFaultController {
	private boolean success;
	private String message;
	private FunUtil funUtil = new FunUtil();
	protected final Log log = LogFactory.getLog(CommunicationFaultController.class);
	...
	public void info(HttpServletRequest request, HttpServletResponse response) {
		...
		result.put("totals", CommunicationFaultService.Count(map));
		result.put("items", CommunicationFaultService.radioUserBusinessInfo(map));
	 ...
	 */
	@RequestMapping("/add")
	public void insertRadioUser(CommunicationFault record, HttpServletRequest request,
			HttpServletResponse response) {
		this.success = true;
		// 获取当前时间
		Date d = new Date();
		...
		record.setStatus(0);
		int count = CommunicationFaultService.insert(record);
		HashMap result = new HashMap();
		result.put("success", success);

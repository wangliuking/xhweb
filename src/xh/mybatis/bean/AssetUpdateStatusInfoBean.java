...
public class AssetUpdateStatusInfoBean {
	private int id;
	private int type;
	private String name;
	...
	public String toString() {
		return "AssetUpdateStatusInfoBean [id=" + id + ", type=" + type
				+ ", name=" + name + ", model=" + model + ", serialNumber="
				+ serialNumber + ", price=" + price + ", ratValue=" + ratValue
				+ ", number=" + number + ", from=" + from + ", status="
				+ status + ", afterStatus=" + afterStatus + ", note=" + note
				+ ", createTime=" + createTime + ", isLock=" + isLock

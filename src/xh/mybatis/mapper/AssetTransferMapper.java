...
public interface AssetTransferMapper {
	 ...
	 * @throws Exception
	 */
	public List<AssetTransferBean> assetTransfer(Map<String,Object> map)throws Exception;
	/**
	 * 查询资产移交记录的总数
	 * @return
	 * @throws Exception
	 */
	public int assetTransferCount(Map<String,Object> map)throws Exception;
	/**
	 * 添加资产移交
	 * @param bean
	 * @return
